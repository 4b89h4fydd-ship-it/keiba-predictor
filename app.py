...
<link rel="manifest" href="/manifest-v63.webmanifest">
<link rel="stylesheet" href="/styles-v63.css">
<title>競馬展開AI</title>
</head>
<body>
<div id="app"><div class="boot">競馬展開AIを起動中…</div></div>
<script src="/app-v63.js"></script>
</body>
</html>"""
...
function cacheKey(d){return "keiba:v63:races:"+d}
...
return '<div class="home-shell"><div class="home-hero"><img class="hero-horse" src="/hero-horse.webp?v=63" alt=""><div class="brand-wrap"><div class="brand-main">競馬展開<span class="ai">AI</span></div><div class="brand-sub">Race Intelligence · v63</div></div><button class="hero-refresh" data-action="reload"><span class="refresh-icon">↻</span><small>更新</small></button></div><main class="home-main">'+
...
@app.get("/build")
def build_info():
    return {"build":"v63","appVersion":"7.5-production-v62-tap-pace-stages","recentRuns":5,"marks":True,"manualMarks":False,"horseModalSwipe":True,"horseDetailSheet":True,"paceStageControl":"tap-only","runtimeDepsFixed":True,"grade":"S/A/B/C + ◎○▲☆△注","history":"NAR + JRA公式/central feed auto-search","pastRaceOpen":True,"historySpeed":"instant-render+background-fill+parallel-prefetch","narWorkers":int(os.getenv("NAR_HISTORY_WORKERS","6")),"centralWorkers":int(os.getenv("CENTRAL_HISTORY_WORKERS","6"))}
...
@app.get("/manifest-v63.webmanifest")
def manifest():
