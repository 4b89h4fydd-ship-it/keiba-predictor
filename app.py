...
app = FastAPI(title="競馬展開AI", version="6.6-production-v50-instant-five-history")
...
<link rel="manifest" href="/manifest-v50.webmanifest">
<link rel="stylesheet" href="/styles-v50.css">
<title>競馬展開AI</title>
</head>
<body>
<div id="app"><div class="boot">競馬展開AIを起動中…</div></div>
<script src="/app-v50.js"></script>
</body>
</html>"""
...
function cacheKey(d){return "keiba:v50:races:"+d}
...
function header(title,back,sub){return '<header class="header"><div class="header-row">'+(back?'<button data-action="back">‹</button>':'')+'<div class="header-title"><h1>'+esc(title)+'</h1>'+(sub?'<small>'+esc(sub)+'</small>':'')+'</div><span class="build-badge">v50</span><button data-action="reload">↻</button></div></header>'}
...
return '<div class="home-shell"><div class="home-hero"><img class="hero-horse" src="/hero-horse.webp?v=50" alt=""><div class="brand-wrap"><div class="brand-main">競馬展開<span class="ai">AI</span></div><div class="brand-sub">Race Intelligence · v50</div></div><button class="hero-refresh" data-action="reload"><span class="refresh-icon">↻</span><small>更新</small></button></div><main class="home-main">'+
...
@app.get("/build")
def build_info():
    return {"build":"v50","appVersion":"6.6-production-v50-instant-five-history","recentRuns":5,"marks":True,"grade":"S/A/B/C + ◎○▲☆△注","history":"NAR + JRA公式/central feed auto-search","pastRaceOpen":True,"historySpeed":"instant-render+background-fill+parallel-prefetch","narWorkers":int(os.getenv("NAR_HISTORY_WORKERS","6")),"centralWorkers":int(os.getenv("CENTRAL_HISTORY_WORKERS","6"))}
...
@app.get("/manifest-v50.webmanifest")
def manifest():
