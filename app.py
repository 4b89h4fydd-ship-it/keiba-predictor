...
app = FastAPI(title="競馬展開AI", version="8.6-production-v74-jra-fast-odds")
...
<link rel="manifest" href="/manifest-v74.webmanifest">
<link rel="stylesheet" href="/styles-v74.css">
<title>競馬展開AI</title>
</head>
<body>
<div id="app"><div class="boot">競馬展開AIを起動中…</div></div>
<script src="/app-v74.js"></script>
</body>
</html>"""
...
function cacheKey(d,c){return "keiba:v74:races:"+d+":"+(c||state.circuit||"")}
...
return '<div class="home-shell"><div class="home-hero"><img class="hero-horse" src="/hero-horse.webp?v=74" alt=""><div class="brand-wrap"><div class="brand-main">競馬展開<span class="ai">AI</span></div><div class="brand-sub">Race Intelligence · v74</div></div><button class="hero-refresh '+(state.loading?'is-loading':'')+'" data-action="reload"><span class="refresh-icon">↻</span><small>'+(state.loading?'更新中':'更新')+'</small></button></div><main class="home-main">'+
...
@app.get("/build")
def build_info():
    return {"build":"v74","appVersion":"8.6-production-v74-jra-fast-odds","recentRuns":5,"allCentralVenues":True,"deterministicCentralDetailId":True,"centralResults":True,"centralLiveOddsApi":True,"scenarioABCSelectable":True,"scenarioHorseNumbers":True,"stickyVenueHeader":True,"circuitSpecificFetch":True,"manualCollect":True,"builtInSources":["JRA公式","NAR公式","netkeiba"],"smartRcDirectLink":False,"multiSource":True,"nonBlocking":True,"grade":"S/A/B/C + ◎○▲☆△注"}
...
@app.get("/manifest-v74.webmanifest")
def manifest():
